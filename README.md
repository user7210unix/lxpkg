  ...
  <h2 style="font-size: 54px;">
    <strong>
      <a href="https://learnixos.github.io/" style="text-decoration: none; color: inherit;">
        <img src="https://learnixos.github.io//favicon.ico" alt=" Icon" style="vertical-align: middle; width: 24px; height: 24px; margin-right: 8px;">
...
<h1>
      <img src="assets/images/image1.png" align="right" alt="Rice Setup Preview" width="550" style="display: block; margin: 32px auto; border: 2px solid #555; border-radius: 12px; box-shadow: 0 4px 10px rgba(0, 0, 0, 0.3);">
</div>
</div> 
...
<h1>
      <img src="assets/images/image2.png" align="left" alt=" Preview" width="550" style="display: block; margin: 32px auto; border: 2px solid #555; border-radius: 12px; box-shadow: 0 4px 10px rgba(0, 0, 0, 0.3);">
</div>
</div> 
